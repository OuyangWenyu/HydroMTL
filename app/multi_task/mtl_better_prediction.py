...
# valid for q
exps_q_et_valid = ["exp41001"] + mtl_q_et_valid_exps
exps_q_et_test = ["exp410010"] + mtl_q_et_test_exps

# valid for et
exps_et_q_valid = ["exp42001"] + mtl_q_et_valid_exps
exps_et_q_test = ["exp42001"] + mtl_q_et_test_exps
...
if (
    ...
    # q when best4q
    (exps_q_et_results, _, preds_q_lst, obss_q_lst,) = read_multi_single_exps_results(
...
both_positive_q = np.where((exps_q_et_results[1] > 0) & (exps_q_et_results[0] > 0))[0]
